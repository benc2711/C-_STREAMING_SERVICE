...
Content::Content(int id, string name, int nr, int ts, int rating)
...
Series::Series(int id, string name, int nr, int ts, int rating, int numEpisodes):
    Content(id, name, nr , ts, rating)
{
    
    numEpisodes_ = numEpisodes;
}
Movie::Movie(int id, string name, int nr, int ts, int rating):
    Content(id, name, nr , ts, rating)
